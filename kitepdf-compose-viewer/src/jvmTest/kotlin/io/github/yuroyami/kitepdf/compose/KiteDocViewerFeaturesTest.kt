 ...
 * compensation in [KitePageRasterizer].
 */
class KiteDocViewerFeaturesTest {
    ...
    fun pagedLayout_navigates_via_state_and_updates_currentPage() {
        ...
        var stateRef: KiteDocViewState? = null
    ...
    fun horizontal_continuous_layout_lays_pages_side_by_side() {
        ...
        val frame = ImageComposeScene(width = 320, height = 200, density = Density(1f)) {
            KiteDocView(
                ...
                modifier = Modifier.fillMaxSize(),
                layout = KiteDocLayout.Continuous(androidx.compose.foundation.gestures.Orientation.Horizontal),
            )
        }.use { scene ->
