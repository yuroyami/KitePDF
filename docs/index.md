...
!!! note "Not using Kotlin Multiplatform?"
    The same artifact works in a plain Android or JVM project. Add `io.github.yuroyami:kitepdf:0.5.0` to your normal `dependencies { }` block.
...
```kotlin
implementation("io.github.yuroyami:kitepdf-native-renderer:0.5.0")  // or kitepdf-skia-renderer
```
