...
/**
 * Headless rendering on iOS — produces a PNG-encoded [NSData] sized to the
 * page in pt × [scale]. No Compose dependency.
 *
 * Typical uses:
 *
 ...
 *
 * For drawing into a UIView's `drawRect:` directly, instantiate
 * [CoreGraphicsCanvas] over `UIGraphicsGetCurrentContext()` instead — the
 * rasterizer is for off-screen output.
 */
@OptIn(ExperimentalForeignApi::class)
object IosPdfRasterizer {
