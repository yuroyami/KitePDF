...
data class PdfOptionalContent(
    ...
    companion object {
        ...
        private fun unwrap(obj: com.yuroyami.kitepdf.parser.PdfObject, refs: IndirectResolver): Pair<PdfDictionary, String>? {
            return when (obj) {
                is PdfReference -> {
        ...
        private fun parseIntent(obj: com.yuroyami.kitepdf.parser.PdfObject?): List<String> = when (obj) {
            null -> emptyList()
