...
internal object DefaultColorSpaces {
    ...
    fun shading(
        ...
        val source = runCatching { resources?.getDict("ColorSpace", refs)?.get(key) }.getOrNull() ?: return value
    ...
    fun pattern(
        ...
        val replaced = shading(entry, resources, colorSpaces, refs)
    ...
    private fun isUsable(space: KiteColorSpace, device: KiteColorSpace): Boolean =
