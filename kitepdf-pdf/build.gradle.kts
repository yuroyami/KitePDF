...
val generateVersionKt = tasks.register("generateVersionKt") {
    ...
    val outDir = layout.buildDirectory.dir("generated/kitepdf")
    inputs.property("version", versionValue)
    outputs.dir(outDir)
    doLast {
        val file = outDir.get().file("Version.kt").asFile
        file.parentFile.mkdirs()
        file.writeText(
            """
            |// Generated by the generateVersionKt Gradle task. Do not edit.
            |package io.github.yuroyami.kitepdf
            |
            |internal const val KITEPDF_VERSION: String = "$versionValue"
            |""".trimMargin(),
        )
    }
}
