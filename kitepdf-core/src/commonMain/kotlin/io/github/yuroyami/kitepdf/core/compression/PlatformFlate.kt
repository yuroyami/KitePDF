 ...
 *
 * Contract: any failure returns null rather than throwing. That covers malformed
 * data, truncation, an output larger than `maxOutput`, and unsupported features
 * such as a preset dictionary. The pure-Kotlin path then reproduces the proper
