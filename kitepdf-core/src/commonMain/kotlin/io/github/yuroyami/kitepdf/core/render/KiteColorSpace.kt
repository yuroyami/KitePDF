 ...
 */
public sealed class KiteColorSpace {
    ...
    public object DeviceRGB : KiteColorSpace() {
    ...
    public object DeviceCMYK : KiteColorSpace() {
         ...
         * sRGB and agrees with MuPDF's ICC conversion within a level or two. ISO 32000-1,
         * 8.6.4.4 leaves this conversion to the reader (#299).
         */
        override fun toRgb(components: DoubleArray): RgbColor = AdobeCmyk.toRgb(
            components.getOrElse(0) { 0.0 },
            components.getOrElse(1) { 0.0 },
            components.getOrElse(2) { 0.0 },
            components.getOrElse(3) { 0.0 },
        )

        /** The initial colour, black ink alone (ISO 32000-1, 8.6.4.4), converted like any other. */
        override fun defaultColor(): RgbColor = AdobeCmyk.toRgb(0.0, 0.0, 0.0, 1.0)
    }
    ...
    public class Indexed(
        public val base: KiteColorSpace,
    ...
    public class DeviceN(
        ...
        public val alternate: KiteColorSpace,
    ...
    public companion object {
        ...
        private fun resolveByName(name: String): KiteColorSpace = when (name) {
