...
| Most Indic scripts are not reordered | Every GSUB lookup type applies, contextual and chaining substitution included, in the stages HarfBuzz uses, and GPOS attaches marks to bases, ligatures and other marks. Devanagari and Bengali syllables are reordered as HarfBuzz reorders them. Gurmukhi, Gujarati, Oriya, Tamil, Telugu, Kannada, Malayalam and Sinhala are not yet, and Thai sara am is not decomposed. |
