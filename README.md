...
Ten artifacts are published, all at `0.8.1`. Add one document artifact. Add one
...
```kotlin
implementation("io.github.yuroyami:kitepdf:0.8.1")                   // or kitepdf-pdf
implementation("io.github.yuroyami:kitepdf-skia-renderer:0.8.1")     // exactly one renderer
```
